...
public class Level2InsertTimerIntoDB : MonoBehaviour
{
    ...
    IEnumerator addTimer()
    {
        ...
        // form.AddField("gamestart", "");
        // form.AddField("puzzle1start","" );
        // form.AddField("puzzle1end", "");
        // form.AddField("puzzle2start", "");
        // form.AddField("puzzle2end", "");
        // form.AddField("puzzle3start", "");
        // form.AddField("puzzle3end", "");
        // form.AddField("endtime", "");
